...
from tergite_tuner.lib.utils.redis import _save_parameters_in_transmon
from tergite_tuner.utils.dto.qoi import QOI


def test_save_parameters_in_transmon(redis_connection):
    """
    ...
    _save_parameters_in_transmon(
        node, this_element, name, qoi, ["resonator_minimum"], redis_connection
    )
