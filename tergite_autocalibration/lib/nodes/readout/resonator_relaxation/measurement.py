...
class ResonatorRelaxation(BaseMeasurement):
    ...
    def schedule_function(
        ...
        reset_durations: dict[str, np.ndarray],
        ...
        for acq_cha, (this_qubit, reset_duration_values) in enumerate(
            reset_durations.items()
        ):
            ...
            for reset_indx, reset_duration in enumerate(reset_duration_values):
                ...
                for acq_index, ro_freq in enumerate(frequency_values):
                    ...
                    this_index = reset_indx * number_of_freqs + acq_index
                    ...
                    schedule.add(IdlePulse(reset_duration))
