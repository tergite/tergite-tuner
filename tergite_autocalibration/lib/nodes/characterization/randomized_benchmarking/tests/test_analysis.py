...
def test_randomized_benchmarking_analysis(session_context):
    with loaded_redis(session_context.redis, _redis_values) as rd:
        ...
        fidelity_11 = qoi_11.analysis_result["fidelity"]["value"]
        standard_leakage_11 = qoi_11.analysis_result["leakage"]["value"]
        fidelity_15 = qoi_15.analysis_result["fidelity"]["value"]
